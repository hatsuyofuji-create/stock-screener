...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--universe-file", default=DEFAULT_UNIVERSE,
                    help="ユニバース定義ファイル（既定: universe/leaders_jp_us.txt）")
    ...
    return run(a.target, a.universe_file, a.period, a.mode, a.top, a.leaders_only)
